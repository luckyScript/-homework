...
--    [] -> []
transition_world :: List_2D Cell -> List_2D Cell
transition_world world = move_world world world
...
{-
check elements and change them 
 -}
...
change_state conductor world  = case conductor of
   (_, (x_e, y_e))
             ...
             |otherwise -> (Conductor, (x_e, y_e))
{-
retrive the previous satge to find the occurrence of Head in local elements 
if the condition is true, the funcation changes Cell
-}